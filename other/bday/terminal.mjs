...
async function run() {
	...
	while (true) {
		await type("> Enter the secret code to gain access (hint: your age today): ")
	...
	await type("> Executing program…	")
	await type("> Hello! You have unlocked your message. 	")
	await type("> I am so grateful for all that you have done for me. Enjoy your special day!	")
	await type("> ")
}
